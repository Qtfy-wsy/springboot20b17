  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='maijia'">
			...
			<el-form-item label="身份证号" class="input" v-if="tableName=='maijia'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`maijia` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if(`maijia` == this.tableName && this.ruleForm.shenfenzhenghao&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghao))){
        this.$message.error(`身份证号应输入身份证格式`);
        return
      }
      if(`maijia` == this.tableName && this.ruleForm.jf&&(!this.$validate.isNumber(this.ruleForm.jf))){
        this.$message.error(`积分应输入数字`);
        return
      }
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20211201/1e0b687c860a4e40b25463f62a0c1295.jpg);
