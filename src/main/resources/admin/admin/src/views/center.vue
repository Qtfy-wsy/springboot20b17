  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="身份证号" prop="shenfenzhenghao">
...
export default {
  ...
  mounted() {
    ...
    this.maijiavipOptions = "是,否".split(',')
  },
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'maijia' ==this.flag && this.ruleForm.shenfenzhenghao&&(!checkIdCard(this.ruleForm.shenfenzhenghao))){
        this.$message.error(`身份证号应输入身份证格式`);
        return
      }
      if( 'maijia' ==this.flag && this.ruleForm.jf&&(!isNumber(this.ruleForm.jf))){
        this.$message.error(`积分应输入数字`);
        return
      }
